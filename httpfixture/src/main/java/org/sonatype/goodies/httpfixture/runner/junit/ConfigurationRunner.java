 ...
 * {@link org.sonatype.goodies.httpfixture.runner.annotations.Configurators} takes {@link SuiteConfigurator} classes and
 * uses them to run every test method. Every entry in
 * {@link org.sonatype.goodies.httpfixture.runner.annotations.ConfiguratorList} will be loaded as a resource. The runner
 * expects every line of the resource to be the class name of a SuiteConfigurator.
 * {@link org.sonatype.goodies.httpfixture.runner.annotations.IgnoreConfigurators} may be used to to ignore
