...
public interface KeyStoreManager
{
    ...
    /**
     * Removes a trusted certificate from the store.  Calling this method with an alias that does NOT exist will not throw a KeystoreException.
     *
     ...
     *
     * @throws KeystoreException thrown if the KeyStore has not been initialized, the key could not be found, or an error updating the KeyStore.
     */
