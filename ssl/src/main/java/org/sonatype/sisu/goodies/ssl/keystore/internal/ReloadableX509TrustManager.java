...
/**
 * A X509TrustManager that will can be updated.  The default implementation is not updated when changes made to a keystore.
 * <p/>
    ...
    implements X509TrustManager
{
    ...
    /**
     * Finds and replaces the X509TrustManager with a ReloadableX509TrustManager.  If there is more then one, only the first one will be replaced.
     *
