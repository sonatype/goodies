 ...
 */
package org.sonatype.goodies.testsupport.junit;
...
public class TestInfoRuleTest
{
  ...
  public void testRule() {
    assertThat(infoRule.getClassName(), equalTo("org.sonatype.goodies.testsupport.junit.TestInfoRuleTest"));
    assertThat(infoRule.getMethodName(), equalTo("testRule"));
    assertThat(infoRule.getDisplayName(),
        equalTo("testRule(org.sonatype.goodies.testsupport.junit.TestInfoRuleTest)"));
    assertThat(infoRule.getTestClass().getCanonicalName(),
        equalTo("org.sonatype.goodies.testsupport.junit.TestInfoRuleTest"));
  ...
  public void testClassRule() {
    assertThat(classInfoRule.getClassName(), equalTo("org.sonatype.goodies.testsupport.junit.TestInfoRuleTest"));
    assertThat(classInfoRule.getMethodName(), nullValue());
    assertThat(classInfoRule.getDisplayName(), equalTo("org.sonatype.goodies.testsupport.junit.TestInfoRuleTest"));
