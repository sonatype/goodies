    ...
    extends TestSupport
{
  ...
  public void resolveFromPackage() {
    ...
    assertThat(file, is(equalTo(util.resolveFile(
        "src/test/uncopied-resources/org/sonatype/sisu/goodies/testsupport/junit/from-package"
    ))));
  }
  ...
  public void resolveFromMiddlePackage() {
    ...
    assertThat(file, is(equalTo(util.resolveFile(
        "src/test/uncopied-resources/org/sonatype/sisu/goodies/from-middle-package"
    ))));
  }
  ...
  public void resolveFromOverlay() {
    ...
    assertThat(underTest.resolveFile("from-middle-package"),
        is(equalTo(util.resolveFile("src/test/uncopied-resources/org/sonatype/sisu/goodies/from-middle-package"))));
